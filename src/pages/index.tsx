  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Ananda Dimmas Budiarto - Fullstack Developer And Devops" />
        ...
        <meta name="twitter:title" content="Ananda Dimmas Budiarto - Fullstack Developer And Devops" />
